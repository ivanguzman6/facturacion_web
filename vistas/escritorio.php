...
else
{
    ...
    if($_SESSION['escritorio']==1)
    {
        ...
        //Variables para mostrar el grafico de las barras de compras
        ...
        //Variables para mostrar el grafico de las barras de ventas
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <!-- centro -->
                            <!-- Div para el total de compras y ventas -->
                            ...
                            <!-- Panel para las ultimas 10 compras / ventas -->
                            <div class="panel-body" >
