...
else
{
    ...
    {
        //Incluimos el archvo Factura.php
        require('Factura.php');

        //Establecemos los datos de la empresa
        $logo = "logo.jpg";
        $ext_logo = "jpg";
        $empresa = utf8_decode("Iván Empresa CxA");
        $documento = "130772552";
        $direccion = "Santiago, Rep. Dom.";
        $telefono = "809-123-4567";
        $email = "iguzman@empresa.com";
        ...
        $pdf->addClientAdresse(utf8_decode($regv->cliente),"Domicilio: " . utf8_decode($regv->direccion),$regv->tipo_documento. ": " . $regv->num_documento, "Email: " . $regv->email, utf8_decode("Teléfono: " . $regv->telefono));
       ...
       // $pdf->addLineFormat($cols);
        ...
        $pdf->addCadreEurosFrancs("ITBIS" . "$regv->impuesto %");
    ...
    {
        echo 'Usuario no tiene permisos para visualizar el reporte';
    }
}
ob_end_flush();
?>
